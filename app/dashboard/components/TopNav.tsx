...
export default function TopNav() {
  ...
  return (
    <div className={`flex items-center justify-between rounded-2xl border backdrop-blur-xl px-6 py-4 transition-all duration-300 relative dashboard-nav group ${
      ...
      {/* Left side - Title with dynamic breadcrumb */}
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        <div className={`relative transition-all duration-300 ${
          isSearchFocused ? "w-64 scale-105" : "w-48 scale-100"
        }`}>
          ...
          <input
            ...
            className={`w-full rounded-xl pl-10 pr-4 py-2.5 text-sm outline-none border transition-all duration-300 focus:ring-2 ${
            theme === "dark"
                ? isSearchFocused
